...
This is a useful function for running make_summary() over many variables, and storing them all in one place
...
See <https://aosmith.rbind.io/2019/04/15/custom-contrasts-emmeans/> and <https://cran.r-project.org/web/packages/emmeans/vignettes/comparisons.html#linfcns> 
